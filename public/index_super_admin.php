...
$pageTitle = 'Tableau de bord - Super Admin';
...
<div class="container mt-5">
    <div class="row">
        <div class="col-md-12">
            <h2 class="mb-4">Bienvenue, <?php echo htmlspecialchars($user['prenom'] . ' ' . $user['nom']); ?>! (Super Admin)</h2>
    ...
    <div class="row mb-4">
        <div class="col-md-3">
            <div class="card text-center">
                <div class="card-body">
                    <h5 class="card-title">Tous les Événements</h5>
                    <a href="pages/evenements.php" class="btn btn-primary">Voir tout</a>
                </div>
            </div>
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-3">
            <div class="card text-center">
                <div class="card-body">
                    ...
                    <a href="pages/gestion-utilisateurs.php" class="btn btn-secondary">Gérer</a>
                </div>
            </div>
        </div>
    </div>
